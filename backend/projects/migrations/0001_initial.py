    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('validator', 'Validator'), ('staff', 'Staff')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('proposed', 'Proposed'), ('planning', 'Planning'), ('ongoing', 'Ongoing'), ('completed', 'Completed')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('action', models.CharField(choices=[('create', 'create'), ('update', 'update'), ('request_edit', 'request_edit'), ('approve_edit', 'approve_edit'), ('validate', 'validate'), ('archive', 'archive'), ('freeze', 'freeze'), ('unfreeze', 'unfreeze')], max_length=30)),
